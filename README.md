...
#### 2.1. Настройсте статический маршрут по умолчению на маршрутизаторах **_RTR-L_** и **_RTR-R_**.
...
- c. Сервер делигирует зону `int.demo.wsr` на **_SRV_**;
...
#### 2.4. Выполните настройку второго уровня системы сихронизации времени на **_SRV_**:
